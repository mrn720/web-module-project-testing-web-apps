...
test('renders ONE error message if user enters a valid first name and last name but no email.', async () => {
    ...
    userEvent.type(firstNameInput, 'Matt Norris');
    userEvent.type(lastNameInput, 'matt.ryan.norris@gmail.com');
    const submitButton = screen.getByRole('button');
    userEvent.click(submitButton)
...
test('renders "email must be a valid email address" if an invalid email is entered', async () => {
    ...
    userEvent.type(emailInput, 'matt.ryan.norris')
    const submitButton = screen.getByRole('button');
    userEvent.click(submitButton)
...
test('renders "lastName is a required field" if an last name is not entered and the submit button is clicked', async () => {
    ...
    userEvent.type(emailInput, 'matt.ryan.norris@gmail.com')
    userEvent.type(firstNameInput, 'Matt Norris');
    userEvent.click(submitButton)
...
test('renders all firstName, lastName and email text when submitted. Does NOT render message if message is not submitted.', async () => {
    ...
    userEvent.type(emailInput, 'matt.ryan.norris@gmail.com')
    userEvent.type(firstNameInput, 'Matt');
    userEvent.type(lastNameInput, 'Norris');
    userEvent.click(submitButton)
